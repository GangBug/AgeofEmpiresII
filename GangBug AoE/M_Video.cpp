...
M_Video::M_Video(bool startEnabled) : Module(startEnabled)
...
bool M_Video::Awake(pugi::xml_node& config)
{
	return true;
}

// Called before quitting
bool M_Video::CleanUp()
{
	if (!active)
		return true;
...
// Audio =============================================================================================
AudioQueue* M_Video::audio_queue = NULL;
AudioQueue* M_Video::audio_queue_tail = NULL;

void SDLCALL M_Video::audio_callback(void *userdata, Uint8 *stream, int len)
{
...
void M_Video::queue_audio(const THEORAPLAY_AudioPacket *audio)
{
...
void M_Video::LoadVideo(const char *fname)
{
...
void M_Video::PlayVideo(const char *fname, SDL_Rect r)
{
	// Loading video ---------------------
